...
export class ParallaxDirective implements OnInit {
    ...
    public ngOnInit() {
        ...
        for (const prop in this.config) { this[prop] = this.config[prop]; }
            ...
            if (document.getElementById('parallaxScroll')) {
                ...
                try {
                    ...
                    if (!this.scrollElement) {
                        ...
                        throw new Error((`The ID passed through the parallaxConfig ('${this.scrollerId}') object was not found in the document.  Defaulting to tracking the scrolling of the window.`));
                    }
                } catch (e) {
                    console.warn(e);
